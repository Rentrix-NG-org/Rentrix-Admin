...
const ListingCreationInfo = () => {
  ...
  const fields: { title: string; value: string }[] = [
    { title: "User ID", value: log?.listing?.owner.id || "" },
    { title: "propertyId", value: log?.listing?.id || "" },
    { title: "Location", value: log?.listing?.location.state || "" },
    { title: "Price", value: log?.listing?.fee.fee || "" },
    { title: "Description", value: log?.listing?.description || "" },
    { title: "Details", value: log?.description || "" },
    { title: "Timestamps", value: log?.createdAt || "" },
...
export default ListingCreationInfo;
