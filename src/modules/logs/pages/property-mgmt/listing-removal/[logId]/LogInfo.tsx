...
const ListingRemovalInfo = () => {
  ...
  const fields: { title: string; value: string }[] = [
    ...
    { title: "Property ID", value: log?.listing?.id || "" },
    { title: "Reasons For Removal", value: log?.action || "" },
    { title: "System Confirmation", value: log?.description || "" },
...
export default ListingRemovalInfo;
