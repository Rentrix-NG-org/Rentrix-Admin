...
const PaymentInitiationInfo = () => {
  ...
  const fields: { title: string; value: string }[] = [
    { title: "User ID (Tenant)", value: log?.user?.id || "" },
    { title: "PaymentMethod", value: log?.action || "" },
    { title: "Amount", value: log?.amount?.toString() || "" },
    { title: "Transaction ID", value: log?.transaction?.id || "" },
...
export default PaymentInitiationInfo;
